...
import 'package:fairmatic_sdk_flutter/fairmatic_platform_interface.dart';
import 'package:fairmatic_sdk_flutter/fairmatic_sdk_flutter.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:plugin_platform_interface/plugin_platform_interface.dart';

void main() {
  final FairmaticSdkFlutterPlatform initialPlatform =
      FairmaticSdkFlutterPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFairmaticSdkFlutterPlatform fakePlatform =
        MockFairmaticSdkFlutterPlatform();
